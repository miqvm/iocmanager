...
// Pintar el llistat d'indicadors de compromis que es passi per parametre
// Usat en /search o en /list (NO ESTA HABILITAT EL MODUL EN L'APLICACIO)
function draw_iocs_list($iocs_list)
  ...
  // Pintar el panell de visualitzacio d'un IoC
  function draw_ioc_view($id_ioc)
  {
    ...
    // Si es de tipus URL o DOMAIN posar en name_ioc la URL ja que en la bbdd es guarda a name_ioc la URL hashejada
...
echo '
  ...
  $info = $GLOBALS['ioc']->list_ioc_reason_short($id_ioc);
    ...
    // Color de TLP segons el valor de Share Level
 ...
 echo '      </tbody>
  ...
  // Pintar el formulari d'edicio de IOC
...
';
 ...
 echo '      </tbody>
  ...
  // Pintar formulari d'edicio d'una Reason
  ...
  // Pintar el panell de visualitzacio d'una Reason
  ...
  // Pintar el formulari de creacio d'un IOC i el seu Reason
  ...
  // Cridar al llistat dels IOC llistats
