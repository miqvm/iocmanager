...
class input
{
	...
	//	OUTPUT:	Array
	//
	//		Retorna un array de tots els Input Devices.
	//
	//--------------------------------------------------------------------------
	...
	//	OUTPUT:	Integer
	//
	//		Returns the ID of the inserted input
	//
	//--------------------------------------------------------------------------
	...
	//	OUTPUT:	Array
	//
	//		Returns an array with the input method name and ID.
	//
	//--------------------------------------------------------------------------
	...
	//	OUTPUT:	Array
	//
	//		Returns an array with the all the input methods names and IDs.
	//
	//--------------------------------------------------------------------------
	...
	//
	//		Also Update RSyslog.conf and restart RSyslog service
	//
	//--------------------------------------------------------------------------
	function update_input($id_input, $input)
   	{  	
		...
		// Update RSyslog.conf if the IP is modified
	...
	//	OUTPUT:	String
	//
	//		Returns Method parameters of a input method
	//
	//--------------------------------------------------------------------------
	...
	//	OUTPUT:	Boolean
	//
	//		Updates Syslog.conf and restart service
	//
	//--------------------------------------------------------------------------
